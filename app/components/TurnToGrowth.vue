...
<template>
    <div class="w-full max-w-[712px] flex flex-col items-center gap-[24px]">
        <h2 class="text-[48px] font-bold text-center">
        ...
        <div class="grid grid-cols-3 center">
            ...
            <div class="flex flex-col items-center text-center">
                <h3 class="font-bold text-[38px]">70%</h3>
                <p class="opacity-[0.5]">Increase in form workforce</p>
            </div>
            <div class="flex flex-col items-center text-center">
                <h3 class="font-bold text-[38px]">40%</h3>
